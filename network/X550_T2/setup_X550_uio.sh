...
modprobe uio
insmod /data/repo/dpdk-kmods/linux/igb_uio/igb_uio.ko 
...
dpdk-devbind.py -b igb_uio 05:10.0
dpdk-devbind.py -b igb_uio 05:10.1
# Add VF for 05:11.0(enp5s0f1)
dpdk-devbind.py -b igb_uio 05:10.2
dpdk-devbind.py -b igb_uio 05:10.3
...
dpdk-devbind.py -b igb_uio 05:10.2
dpdk-devbind.py -b igb_uio 05:10.3
dpdk-devbind.py -b igb_uio 05:10.4
dpdk-devbind.py -b igb_uio 05:10.5
dpdk-devbind.py -b igb_uio 05:10.6
dpdk-devbind.py -b igb_uio 05:10.7
# Add VF for 05:11.0(enp5s0f1)
dpdk-devbind.py -b igb_uio 05:11.0
dpdk-devbind.py -b igb_uio 05:11.1
dpdk-devbind.py -b igb_uio 05:11.2
dpdk-devbind.py -b igb_uio 05:11.3
dpdk-devbind.py -b igb_uio 05:11.4
dpdk-devbind.py -b igb_uio 05:11.5
dpdk-devbind.py -b igb_uio 05:11.6
dpdk-devbind.py -b igb_uio 05:11.7
dpdk-devbind.py -s
